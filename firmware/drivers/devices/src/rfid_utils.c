...
void setupRFID(MFRC522Ptr_t* mfrc522) {
	*mfrc522 = MFRC522_Init();
	...
	// // Set pins as// GPIO
	//Chip_SCU_PinMuxSet(0x6, 1, (SCU_PINIO_FAST | SCU_MODE_FUNC0));
	//Chip_SCU_PinMuxSet(0x6, 4,(SCU_PINIO_FAST | SCU_MODE_FUNC0));

	// GPIO1[0]= P1_07
	(*mfrc522)->_chipSelectPin = 9;
	// GPIO5[2]
	(*mfrc522)->_resetPowerDownPin = 18;
